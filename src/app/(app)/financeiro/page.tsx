...
import { Wallet, TrendingUp, Receipt, ArrowDownCircle, Scale, Trash2, Plus } from "lucide-react";
...
export default async function FinanceiroPage() {
  const [pedidos, despesas, dStats] = await Promise.all([
    listPedidos(),
    listDespesas(),
    despesaStats(),
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-3 grid-cols-2 lg:grid-cols-5">
        ...
        <StatCard label="Recebido" value={formatBRL(recebido)} icon={Receipt} tone="info" />
